...
import kr.or.btf.web.domain.web.QBanner;
...
import kr.or.btf.web.repository.web.BannerRepository;
...
public class BannerService extends _BaseService {
    ...
    public Page<Banner> list(Pageable pageable, SearchForm searchForm, BannerForm bannerForm) {
    ...
    public List<Banner> list(SearchForm searchForm, BannerForm bannerForm) {
    ...
    @Transactional
    public Banner insert(BannerForm bannerForm, MultipartFile attachImgFl, MultipartFile attachMoImgFl) throws Exception {
    ...
    @Transactional
    public boolean update(BannerForm bannerForm, MultipartFile attachImgFl, MultipartFile attachMoImgFl) {
