...
public class MyPageController extends BaseCont {
    ...
    public String myWorkPreEduList(Model model,
        ...
        Page<Prevention> preventions = applicationService.getMyPreEduList(pageable,account.getId());
        model.addAttribute("preList", preventions);

        model.addAttribute("mc", "myPage");
        model.addAttribute("pageTitle", "예방교육관리");
        return "/pages/myPage/myWorkPreEduList";
    }
